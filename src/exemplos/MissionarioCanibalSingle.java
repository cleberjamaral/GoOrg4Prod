 ...
 * @version (02/04/2004)
 */
public class MissionarioCanibalSingle implements Estado, Antecessor{
    ...
    public MissionarioCanibalSingle(int m, int c,char b, String o) {
        missionario = m;
        canibal = c;
        barco = b;
        op = o;
    ...
    public void levar1m(List<Estado> suc){
        ...
        if (barco == 'e' && missionario > 0){
            //Gera um sucessor
            MissionarioCanibalSingle novo = new MissionarioCanibalSingle(missionario-1,canibal,'d',"Levar 1 mission�rio para margem direita");
            ...
            if (barco == 'd' && missionario < 3) {
                //Gerar o sucessor
                MissionarioCanibalSingle novo = new MissionarioCanibalSingle(missionario+1,canibal,'e',"Levar 1 mission�rio para margem esquerda");
    ...
    public void levar2m(List<Estado> suc){
        ...
        if (barco == 'e' && missionario > 1){
            //Gerar o sucessor
            MissionarioCanibalSingle novo = new MissionarioCanibalSingle(missionario-2,canibal,'d',"Levar 2 mission�rios para margem direita");
            //Verificar se ele � valido
            if (novo.ehValido())
                //Adicionar na lista de sucessores
                suc.add(novo);
            ...
            if (barco == 'd' && missionario < 2){
                //Gerar sucessor
                MissionarioCanibalSingle novo = new MissionarioCanibalSingle(missionario+2,canibal,'e',"Levar 2 mission�rios para margem esquerda");
                //Verificar se ele � valido
                if (novo.ehValido())
                    //Adicionar na lista de sucessores
                    suc.add(novo);
    ...
    public void levar1m1c(List<Estado> suc){
        ...
        if (barco == 'e' && missionario > 0 && canibal > 0){
            //Gerar sucessor
            MissionarioCanibalSingle novo = new MissionarioCanibalSingle(missionario-1,canibal-1,'d',"Levar 1 mission�rio e 1 canibal para margem direita");
            //Verificar se ele � valido
            if (novo.ehValido())
                //Adicionar na lista de sucessores
                suc.add(novo);
            ...
            if (barco == 'd' && missionario < 3 && canibal <3){
                //Gerar Sucessor
                MissionarioCanibalSingle novo = new MissionarioCanibalSingle(missionario+1,canibal+1,'e',"Levar 1 mission�rio e 1 canibal para margem esquerda");
    ...
    public void levar1c(List<Estado> suc){
        ...
        if (barco == 'e' && canibal > 0){
            //Gerar sucessor
            MissionarioCanibalSingle novo = new MissionarioCanibalSingle(missionario,canibal-1,'d',"Levar 1 canibal para margem direita");
            //Verificar se ele � v�lido
            if (novo.ehValido())
                //Adicionar na lista
                suc.add(novo);
            ...
            if (barco == 'd' && canibal < 3){
                //Gerar sucessor
                MissionarioCanibalSingle novo = new MissionarioCanibalSingle(missionario,canibal+1,'e',"Levar 1 canibal para margem esquerda");
                //Verificar se ele � v�lido
                if (novo.ehValido())
                    //Adicionar na lista de sucessores
                    suc.add(novo);
    ...
    public void levar2c(List<Estado> suc){
        ...
        if (barco == 'e' && canibal > 1){
            //Gerar sucessor
            MissionarioCanibalSingle novo = new MissionarioCanibalSingle(missionario,canibal-2,'d',"Levar 2 canibais para margem direita");
            //Verificar se � v�lido
            if (novo.ehValido())
                //Adicionar na lista de sucessores
                suc.add(novo);
            ...
            if (barco == 'd' && canibal < 2){
                //Gerar sucessor
                MissionarioCanibalSingle novo = new MissionarioCanibalSingle(missionario,canibal+2,'e',"Levar 2 canibais para margem esquerda");
                //Verificar se ele � v�lido
                if (novo.ehValido())
                    //Adicionar na lista
                    suc.add(novo);
    ...
    public static void main(String[] a) throws IOException {
        MissionarioCanibalSingle inicial = new MissionarioCanibalSingle(3,3,'e',"");
        MissionarioCanibalSingle finau = new MissionarioCanibalSingle(0,0,'d',"");
    ...
    public boolean equals(Object o) {
    	try {
            MissionarioCanibalSingle e = (MissionarioCanibalSingle)o;
