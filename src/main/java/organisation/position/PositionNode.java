...
public class PositionNode implements Requirement {
	...
	public void addDataLoad(DataLoad dataload) {
		// in positions getSender() always return null it must be done by getSenderName()
	...
	public double calculateAddedDataLoad(GoalNode goal) {
		...
		// Considering only "non-circular" dataloads to new position (informs are not used for positions)
